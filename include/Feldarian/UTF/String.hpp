...
requires Feldarian::Base::UTF::IsUTFCharType<UTFCharTypeInput>
struct hash<Feldarian::Base::UTF::StringWrapper<UTFCharTypeInput, CaseSensitiveInput, UTFCharTypeTraitsInput, UTFAllocatorInput>>
{
  [[nodiscard]] size_t operator()(const Feldarian::Base::UTF::StringWrapper<UTFCharTypeInput, CaseSensitiveInput, UTFCharTypeTraitsInput, UTFAllocatorInput>& utf) const noexcept
  {
    return Feldarian::Base::UTF::StringHasher<CaseSensitiveInput>{}(utf);
  }
};

template <typename UTFCharTypeInput, bool CaseSensitiveInput, typename UTFCharTypeTraitsInput>
requires Feldarian::Base::UTF::IsUTFCharType<UTFCharTypeInput>
struct hash<Feldarian::Base::UTF::StringViewWrapper<UTFCharTypeInput, CaseSensitiveInput, UTFCharTypeTraitsInput>>
{
  [[nodiscard]] size_t operator()(const Feldarian::Base::UTF::StringViewWrapper<UTFCharTypeInput, CaseSensitiveInput, UTFCharTypeTraitsInput>& utf) const noexcept
  {
    return Feldarian::Base::UTF::StringViewHasher<CaseSensitiveInput>{}(utf);
  }
};
...
requires Feldarian::Base::UTF::IsUTFCharType<UTFCharTypeInput>
struct formatter<Feldarian::Base::UTF::StringWrapper<UTFCharTypeInput, CaseSensitiveInput, UTFCharTypeTraitsInput, UTFAllocatorInput>, UTFCharTypeOutput>
{
  ...
  [[nodiscard]] auto format(const Feldarian::Base::UTF::StringWrapper<UTFCharTypeInput, CaseSensitiveInput, UTFCharTypeTraitsInput, UTFAllocatorInput>& utf, FormatContext& context) const
  {
    ...
    else if constexpr (Feldarian::Base::UTF::IsSameUTFCharType<UTFCharTypeInput, UTFCharTypeOutput>)
      return std::formatter<Feldarian::Base::UTF::StringViewWrapper<UTFCharTypeOutput>, UTFCharTypeOutput>{}.format(utf.native(), context);
    else
      return std::formatter<Feldarian::Base::UTF::StringWrapper<UTFCharTypeOutput, CaseSensitiveInput, UTFCharTypeTraitsInput, UTFAllocatorInput>, UTFCharTypeOutput>{}.format(utf.native(), context);
  }
};

template <typename UTFCharTypeOutput, typename UTFCharTypeInput, bool CaseSensitiveInput, typename UTFCharTypeTraitsInput>
requires Feldarian::Base::UTF::IsUTFCharType<UTFCharTypeInput>
struct formatter<Feldarian::Base::UTF::StringViewWrapper<UTFCharTypeInput, CaseSensitiveInput, UTFCharTypeTraitsInput>, UTFCharTypeOutput>
{
  template <typename FormatParseContext>
  [[nodiscard]] auto parse(FormatParseContext& parseContext) const
  {
  ...
  template<class FormatContext>
  [[nodiscard]] auto format(const Feldarian::Base::UTF::StringViewWrapper<UTFCharTypeInput, CaseSensitiveInput, UTFCharTypeTraitsInput>& utf, FormatContext& context) const
  {
    if constexpr (std::same_as<UTFCharTypeInput, UTFCharTypeOutput>)
      return std::formatter<std::basic_string_view<UTFCharTypeInput, UTFCharTypeTraitsInput>, UTFCharTypeOutput>{}.format(utf.native(), context);
    else if constexpr (Feldarian::Base::UTF::IsSameUTFCharType<UTFCharTypeInput, UTFCharTypeOutput>)
      ...
      return std::formatter<Feldarian::Base::UTF::StringWrapper<UTFCharTypeOutput, CaseSensitiveInput, UTFCharTypeTraitsInput>, UTFCharTypeOutput>{}.format(utf.native(), context);
  }
};
...
struct formatter<Feldarian::Base::UTF::StringWrapper<UTFCharTypeInput, CaseSensitiveInput, UTFCharTypeTraitsInput, UTFAllocatorInput>, UTFCharTypeOutput>
{
  ...
  [[nodiscard]] auto format(const Feldarian::Base::UTF::StringWrapper<UTFCharTypeInput, CaseSensitiveInput, UTFCharTypeTraitsInput, UTFAllocatorInput>& utf, FormatContext& context) const
  {
    if constexpr (std::same_as<UTFCharTypeInput, UTFCharTypeOutput>)
      ...
      return fmt::formatter<Feldarian::Base::UTF::StringViewWrapper<UTFCharTypeOutput>, UTFCharTypeOutput>{}.format(utf.native(), context);
    else
      return fmt::formatter<Feldarian::Base::UTF::StringWrapper<UTFCharTypeOutput, CaseSensitiveInput, UTFCharTypeTraitsInput, UTFAllocatorInput>, UTFCharTypeOutput>{}.format(utf.native(), context);
  }
};
...
struct formatter<Feldarian::Base::UTF::StringViewWrapper<UTFCharTypeInput, CaseSensitiveInput, UTFCharTypeTraitsInput>, UTFCharTypeOutput>
{
  ...
  [[nodiscard]] auto format(const Feldarian::Base::UTF::StringViewWrapper<UTFCharTypeInput, CaseSensitiveInput, UTFCharTypeTraitsInput>& utf, FormatContext& context) const
  {
    if constexpr (std::same_as<UTFCharTypeInput, UTFCharTypeOutput>)
      ...
      return fmt::formatter<Feldarian::Base::UTF::StringWrapper<UTFCharTypeOutput, CaseSensitiveInput, UTFCharTypeTraitsInput>, UTFCharTypeOutput>{}.format(utf.native(), context);
  }
};
